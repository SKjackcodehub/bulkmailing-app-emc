...
function App() {
   ...
   function send(){
    setstatus(true)
    axios.post("http://localhost:8080/sendemail",{msg:msg,emailList:emailList})
    .then(function(data){
      if(data.data=== true)
      {
        alert("Email successful sended...")
        setstatus(false)
      }
      else{
        alert("Failed")
  ...
  return (
    <div>
      <div className='bg-blue-950 text-white text-center'>
        <h1 className='text-2xl font-medium px-5 py-3'>Bulk Mailing</h1>
      ...
      </div> <div className='bg-blue-200 text-white text-center p-8'>
